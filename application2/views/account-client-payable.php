    ...
    <div class="">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Clients - Payable</li>
            </ol>
      <!-- Client DataTables Card -->
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Client Payble - Cycle <?php echo $start_date; echo ' -- '; echo $end_date; ?>
        </div>
    </div>
    <div class="card-header">
...
?>
            ...
            ?>
                <a href="<?php echo site_url('Account/client_detail_payable/'.$user_id) ?>" class="btn btn-default">View Details</a>
            </td>
        <?php }?>
              </tbody>
            </table>
