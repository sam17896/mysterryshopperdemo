    ...
    <div class="">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Client Payable - Detail</li>
            </ol>
      <!-- Client DataTables Card -->
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Client Payable - Detail
        </div>
    </div>
    <div class="card-header">
    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            <!-- <td><img style="width:50px;height:50px;" src="<?php echo $image_path;?>"></td> -->
                ...
                <td><a href="<?php echo site_url('Account/Payment/'.$value['id'])?>">Pay</a></td>
            </tr>
            <?php } ?>
              </tbody>
            </table>
