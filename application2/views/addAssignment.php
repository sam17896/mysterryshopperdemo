    ...
    <div class="container-fluid">
     ...
     <ol class="breadcrumb">
      ...
      <div class="card mb-3">
        ...
        <form class="form-control" action="<?php echo site_url('Assignment/insert')?>" enctype="multipart/form-data" method="post">
          <div class="form-group">
            <div class="form-row">
          <div class="col-md-6 form-group">
          
              <label>Valid From</label>
                <input class="form-control" type="date" name="from_date" id="userdate" onchange="TDate()"  required>      
            </div>
            <div class="col-md-6 form-group">
              <label>Valid Till</label>
                <input class="form-control" type="date" name="to_date" id="userdate" onchange="TDate()"  required>
          ...
          <div class="col-md-6 form-group">
              ...
              <div class="col-md-6 form-group">
                ...
                <select class="form-control" name="assignment_city" required>
    ...
    <div class="form-group">
            <div class="form-row">
              <div class="col-md-6 form-group">
                ...
                <select class="form-control" name="assignment_category" required>
