    ...
    margin : auto;
            ...
            <section class="content">
                <header class="content__title ">
                    <h1>Dashboard</h1>
                    <small>Welcome to Mystery Shopping!</small>
        ...
        <img class="img-responsive img-fluid b"  src="<?php echo base_url(); ?>img/shopping.png" alt="Home">
    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="flot-chart-legends flot-chart-legends--curved">fff</div>
                            </div>
                        </div>
                    </div>
