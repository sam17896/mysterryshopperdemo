     ...
     <ol class="breadcrumb">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-hand-paper-o"></i>Add Assignment</div>
          </div>
        <form class="form-control" name="myForm" action="<?php echo site_url('Assignment/insert')?>" enctype="multipart/form-data" onsubmit="return validateForm()" method="post">
          <div class="form-group">
            <div class="form-row">
          <div class="col-md-6 form-group">
          
              <label>Valid From</label>
                <input class="form-control" type="date" name="from_date" id="userdate" onchange="TDatefrom()"  required>      
            </div>
            <div class="col-md-6 form-group">
              <label>Valid Till</label>
                <input class="form-control" type="date" name="to_date" id="userdate2" onchange="TDateto()"    required>
          ...
          <div class="form-group">
            ...
            <div class="form-row">
              ...
              <label>Rating From</label>
                <input class="form-control txtboxToFilter"   type="text" placeholder="Enter Ratting From " name="rating_from">
              </div>
              <div class="col-md-6 form-group">
              <label>Rating To</label>
                <input class="form-control txtboxToFilter" type="text" placeholder="Enter Ratting To" name="rating_to">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="hidden" value="Open" name="avaiability">
              <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 form-group">
              <label>Budget</label>
                <input class="form-control" type="text" placeholder="Enter Assignment Budget" name="assignment_budget" required>
              </div>
              <div class="col-md-6 form-group">
                <label>Client</label>
                ...
                ?>
                        ...
                        <option value="<?php echo $value['mysteryShopper_client_id'];?>" >
                          <?php echo $value['mysteryShopper_client_name'];?> - <?php echo $value['mysteryShopper_client_owner_name'];?>
                        </option>
                <?php } ?>
               </select>
              </div>
          ...
          <div class="col-md-6 form-group">
              ...
              <div class="col-md-6 form-group">
                ...
                <select class="form-control" name="assignment_city" style="color:#16354e ;font-weight:bold;font-size:15px" required="true" />
...
function validateForm() {
    var city = document.forms["myForm"]["assignment_city"].value;
    var client = document.forms["myForm"]["client"].value;
    var categoery = document.forms["myForm"]["assignment_category"].value;
    
    if (city == "Select City" || city =="") {
    	$('#myModal2').modal('show');
 	$("#msg").text('CITY MUST BE SELECTED.');
        
        return false;
    }
    if (client == "Select Client" || client =="") {
    	$('#myModal2').modal('show');
 	$("#msg").text('CLIENT MUST BE SELECTED.');
        
        return false;
    }
    if (categoery == "Select Category" || categoery =="") {
    	$('#myModal2').modal('show');
 	$("#msg").text('CATEGORY MUST BE SELECTED.');
...
function TDatefrom() {
    ...
    if (UserDate < formatDate(ToDate)) {
    	
 	$('#myModal2').modal('show');
 	
 	$("#msg").text('The Date must be Bigger or Equal to today date');
...
function TDateto() {
    var UserDate = document.getElementById("userdate2").value;
    var ToDate = document.getElementById("userdate").value;
	
    if (UserDate < ToDate) {
    	//$.noConflict();
 	$('#myModal2').modal('show');
 	;
 	$("#msg").text('The Date must be Bigger or Equal to From date');
         //alert("The Date must be Bigger or Equal to today date");
          $("#userdate2").val('');
          return false;
      }
