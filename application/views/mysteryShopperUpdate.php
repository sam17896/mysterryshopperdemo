  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Update Mystery Shopper</li>
      </ol>
      <!-- Client DataTables Card -->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-hand-paper-o"></i>Update Mystery Shopper</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-row">
              ...
              <label>Profile Image</label>
               ...
               <input class="form-control " type="file" placeholder="Select Profile Image" onchange="readURL(this);" id ="picture" name="pic" accept="image/*" >
...
Maximum File Size Limit is 1MB.
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <label>Contact Number</label>
                <input class="form-control txtboxToFilter" type="text" placeholder="Enter  Contact Number" value="<?php echo $allMysteryShopper->mysteryShopper_contact_number?>" name="mystery_shopper_contact_number">
              </div>
              <div class="col-md-3">
              <label>Nic Number</label>
                <input class="form-control txtboxToFilter" type="text" placeholder="Enter  Nic Number" value="<?php echo $allMysteryShopper->mysteryShopper_nic?>" name="mystery_shopper_nic_number">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="col-md-3 form-group">
                 <label>City</label>
                <select class="form-control" style="color:#16354e;font-weight:bold;font-size:15px"   name="mystery_shopper_address" value="<?php echo set_value('mystery_shopper_address');?>">
              ...
              <label>ATM Card Type</label>
                ...
                <select class="form-control" style="color:#16354e;font-weight:bold;font-size:15px"   name="mystery_shopper_card_type">
                 <option ><?php echo $allMysteryShopper->mysteryShopper_card_type?></option>
                  <option>Debit</option>
           ...
           <div class="form-group">
            <div class="form-row">
              <div class="col-md-3 form-group">
              <label>Email (Mystery Shopper user name)</label>
