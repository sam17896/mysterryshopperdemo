...
<?php
                                          ...
                                          $id = $selected_assignment['mysteryShopper_assignment_id']
                    ...
                    <div style="position: relative">
                        ...
                        <div class="product-signup" id="signupForm">
                                ...
                                <div id="signupPrompt" style="">
                                        ...
                                        ?>
                                        <a href="<?php echo site_url('MysteryShopperLoggedin/get_assignment/'.$id) ?>">
	...
	<p><strong>Date: </strong><?php echo date("d/m/Y", strtotime($selected_assignment['mysteryShopper_assignment_fromDate'])); ?>.</p>
	<p><strong>Description: </strong><?php echo $selected_assignment['mysteryShopper_assignment_description']?>.</p>
	<p><strong>Dine/Delivery: </strong><?php echo $selected_assignment['mysteryShopper_assignment_category']?>.</p>
	<p><strong>Budget: </strong> <?php echo $selected_assignment['assignment_budget']?></p> 
