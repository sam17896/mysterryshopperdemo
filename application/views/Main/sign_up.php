        ...
        <div class="container chosen-top">
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-10 white-bg">
                    ...
                    <form action="<?php echo site_url('Web/mysteryShopper_signUp')?>"  method="POST" enctype="multipart/form-data" id="siteForm">
              ...
              <span style="color: red">*</span><label>Name</label>
                <input class="form-control" type="text" name="mystery_shopper_name" aria-describedby="nameHelp" value="<?php echo set_value('mystery_shopper_name');?>" autocomplete="false"  required>
              <span class="text-danger"><?php echo form_error('mystery_shopper_name'); ?></span>
              </div>
              
              <div class="col-md-4">
              <span style="color: red">* </span><label>Contact Number</label>
                <input class="form-control" placeholder="" type="text"  name="mystery_shopper_contact_number" value="<?php echo set_value('mystery_shopper_contact_number');?>" required>
                <span class="text-danger"><?php echo form_error('mystery_shopper_contact_number'); ?></span>
              </div>
              <!-- <div class="col-md-4" >
              <span style="color: red">* </span><label>Nic Number</label>
                <input class="form-control" placeholder="1234512345671" type="text" value="<?php echo set_value('mystery_shopper_nic_number');?>"  id="mystery_shopper_nic_number" name="mystery_shopper_nic_number"  >
                 <span class="text-danger"><?php echo form_error('mystery_shopper_nic_number'); ?></span>
              </div> -->
              <div class="col-md-4" >
              ...
              <label>Bank Name</label>
                <input class="form-control" type="text"  name="mystery_shopper_bank_name" value="<?php echo set_value('mystery_shopper_bank_name');?>" >
              </div> 
              <div class="col-md-4" >
              <label>ATM Card Type</label>
                <input class="form-control" type="text"  name="mystery_shopper_card_type" value="<?php echo set_value('mystery_shopper_card_type');?>" >
              </div>  -->
              <div class="col-md-4" >
              <span style="color: red">* </span><label>Email</label>
                <input class="form-control" type="Email"  name="mystery_shopper_email" value="<?php echo set_value('mystery_shopper_email');?>" required>
                 <span class="text-danger"><?php echo form_error('mystery_shopper_email'); ?></span>
              </div>
              <div class="col-md-4" >
              <span style="color: red">* </span><label>Password</label>
                <input class="form-control" type="Password"  name="userPassword" value="<?php echo set_value('userPassword');?>" required>
                <span style="font-size:12px">(Min Length 8 Characters)</span>
             <span class="text-danger"><?php echo form_error('userPassword'); ?></span>
              ...
              <div class="col-md-4" >
                <label>Profile Video</label>
                 ...
                 <input class="form-control" type="file"  name="profile_video" accept="image/*" >
               </div> 
              <div class="col-md-4" >
              ...
              <label>Account Number</label>
                <input class="form-control" type="text"  name="mystery_shopper_account_number" value="<?php echo set_value('mystery_shopper_account_number');?>" >
              </div> 
              <div class="col-md-4" >
              <span style="color: red">* </span><label>Category</label>
                                ...
                                <select id="example-getting-started" class="form-control" name="category[]" multiple="multiple">
               ...
               <div class="form-group">
                  <div class="row" >
                    ...
                    <input id="register" class="btn btn-green btn-block" type="submit" name="submit" value="SIGN UP">
                    </div>
                    </form>
   </div>
            </div>
