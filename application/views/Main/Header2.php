...
<div class="container-fluid" style="display: none">
  ...
  <nav class="navbar-inverse" style="margin-bottom: 0px !important;  ">
    <div class="container-fluid">
     ...
     <a class="navbar-brand " href="<?php echo site_url(); ?>/Web" style="margin-top:-76px"><img style="margin-right: 10px; padding: 0;" src="<?php echo base_url(); ?>Main/img/msp-logo.png" alt="Dispute Bills"> </a>
      <div id="navbar9" class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="active" ><a href="<?php echo site_url(); ?>/Web/client_login">Client Login</a></li>
          <li class="active" ><a href="<?php echo site_url(); ?>/Web/login">Shopper Login</a></li>
        </ul>
      </div>
      <!--/.nav-collapse -->
    </div>
