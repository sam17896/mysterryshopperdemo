        ...
        <form class="form-control" action="<?php echo site_url('MysteryShopper/add_mystery_shopper')?>" enctype="multipart/form-data" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="col-md-3 form-group">
             <label>City</label>
                <select class="form-control" style="color:#16354e ;font-weight:bold;font-size:15px"   name="mystery_shopper_address" value="<?php echo set_value('mystery_shopper_address');?>" reqiured>
...
font-size: 13px;"   name="mystery_shopper_card_type">
...
font-size: 13px;"   name="category">
              ...
              <label>Profile Image</label>
                ...
                <input class="form-control " type="file" placeholder="Select Profile Image" id="picture" name="pic" accept="image/*">
