    ...
    if($this->session->userdata('username')  && $this->session->userdata('type') == 'MYSTERYSHOPPER')
    {
     ...
     else
     {
      ...
      try{
           ...
           $data['user_id'] = $this->session->userdata('id');
	        //API URL
            $url = base_url().'index.php/Api/allAssignment';
          ...
          $data1['allAssignment'] = $result['data'];
         $expireAssignmentCheck =  $result['data'];



         // print_r($data1['allAssignment'][$i]);
         ...
         if($this->session->userdata('username') && $this->session->userdata('type') == 'MYSTERYSHOPPER')
     {
         ...
         // $fromDate = $value['mysteryShopper_assignment_fromDate'];
          ...
          if($value['mysteryShopper_assignment_toDate'] < date("Y-m-d")){
		     ...
		     //print_r($value['mysteryShopper_assignment_id']);
		    ...
		    $url =  base_url().'index.php/Api/ExpireAssignment';
		    //echo $url;
